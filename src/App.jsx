...
/* =====================================================================
   ...
   ===================================================================== */
const SEED_HISTORY = [
  { number: 1,  date: '2025-01-19', warmUps: [0, 35, 5, 25, 10, 40],         rehearsalSeconds: 240,  notes: '', rating: 1 },
  { number: 2,  date: '2025-01-20', warmUps: [15, 0, 25, 45, 30, 10, 5],     rehearsalSeconds: 270,  notes: '', rating: 1 },
  { number: 3,  date: '2025-01-21', warmUps: [10, 45, 0, 20, 35, 0],         rehearsalSeconds: 300,  notes: '', rating: 1 },
  { number: 4,  date: '2025-01-26', warmUps: [50, 0, 45, 5, 30, 10, 20],     rehearsalSeconds: 240,  notes: '', rating: 4 },
  { number: 5,  date: '2025-01-28', warmUps: [45, 25, 0, 15, 30, 5],         rehearsalSeconds: 330,  notes: '', rating: 1 },
  { number: 6,  date: '2025-01-28', warmUps: [15, 10, 30, 45, 5, 50, 10],    rehearsalSeconds: 360,  notes: '', rating: 1 },
  { number: 7,  date: '2025-01-29', warmUps: [45, 5, 25, 10, 15, 0],         rehearsalSeconds: 330,  notes: '', rating: 1 },
  { number: 8,  date: '2025-01-29', warmUps: [15, 10, 25, 45, 5, 45],        rehearsalSeconds: 390,  notes: '', rating: 1 },
  { number: 9,  date: '2025-01-30', warmUps: [40, 30, 5, 50, 25, 30, 10],    rehearsalSeconds: 330,  notes: '', rating: 3 },
  { number: 10, date: '2025-02-11', warmUps: [30, 5, 35, 15, 45, 20],        rehearsalSeconds: 420,  notes: '', rating: 4 },
  { number: 11, date: '2025-02-12', warmUps: [40, 30, 5, 50, 25, 30, 10],    rehearsalSeconds: 330,  notes: '', rating: 1 },
  { number: 12, date: '2025-02-13', warmUps: [40, 30, 5, 50],                rehearsalSeconds: 330,  notes: '', rating: 1 },
  { number: 13, date: '2025-02-26', warmUps: [5, 35, 15, 45, 20],            rehearsalSeconds: 420,  notes: '', rating: 1 },
  { number: 14, date: '2025-02-27', warmUps: [30, 5, 50, 25, 30, 10],        rehearsalSeconds: 300,  notes: '', rating: 1 },
  { number: 15, date: '2025-02-28', warmUps: [5, 35, 15, 45, 20],            rehearsalSeconds: 510,  notes: '', rating: 1 },
  { number: 16, date: '2025-03-06', warmUps: [5, 35, 15, 45, 20],            rehearsalSeconds: 510,  notes: '', rating: 1 },
...
function HistoryView({ history, goalSeconds, onChangeGoal, askConfirm,
  ...
  const chartData = [...history].sort((a, b) => a.number - b.number).map(s => ({
    session: s.number,
  ...
  // Custom dot that colors by rating
            ...
            <div style={{ width: '100%', height: 200 }}>
              <ResponsiveContainer>
                <LineChart data={chartData} margin={{ top: 8, right: 12, left: -24, bottom: 0 }}>
                  ...
                  <XAxis dataKey="session" tick={{ fontSize: 10, fill: '#8B7B6C' }} axisLine={{ stroke: '#D9CEB8' }} tickLine={false} />
